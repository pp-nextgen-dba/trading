...
- `index.html` - Stock analysis dashboard for TSLA, NVDA, and AMD with quote refresh, chart switching, manual support/resistance levels, risk snapshot, checklist, and separate trade journals.
